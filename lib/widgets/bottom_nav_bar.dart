...
import 'package:myapp_1/Jobs/upload_job.dart';
import 'package:myapp_1/Search/profile_company.dart';
import 'package:myapp_1/Search/search_companies.dart';
...
class BottomNavigationBarForApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CurvedNavigationBar(
      ...
      buttonBackgroundColor: const Color.fromARGB(255, 255, 92, 42),
      height: 50,
      index: indexNum,
      items: const [
        Icon(
